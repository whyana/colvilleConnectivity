...
# Supervised classification - Decision tree ***this is the one we decide to use for the final analysis***, includes code for Figure 3 in the final manuscript.
```{r}
...
# Look at the pixel threshold for the piliouras validation
```{r}
